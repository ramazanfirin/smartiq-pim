...
/**
 * REST controller for managing {@link com.smartiq.pim.domain.Address}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class AddressResource {
    ...
    public AddressResource(AddressRepository addressRepository, UserRepository userRepository) {
