...
describe('BasketItem Management Component', () => {
  let comp: BasketItemComponent;
  let fixture: ComponentFixture<BasketItemComponent>;
  let service: BasketItemService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'basket-item', component: BasketItemComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(BasketItemComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.basketItems?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
