...
export class BasketComponent implements OnInit {
  ...
  trackId(_index: number, item: IBasket): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IBasket[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
