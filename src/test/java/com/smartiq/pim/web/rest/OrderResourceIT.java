...
class OrderResourceIT {
    ...
    void putNewOrder() throws Exception {
        ...
        updatedOrder.createDate(UPDATED_CREATE_DATE).status(UPDATED_STATUS);
    ...
    void partialUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.createDate(UPDATED_CREATE_DATE);
    ...
    void fullUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.createDate(UPDATED_CREATE_DATE).status(UPDATED_STATUS);
